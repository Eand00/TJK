...
public interface CollectionService {
	...
	public Collection addOrUpdateCardToCollection(Integer userId, String cardId, Integer quantity);//check if card already in collection if is update quntity else add to collection
